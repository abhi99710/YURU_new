...
class Splash4 : AppCompatActivity() {
    ...
    private fun videoPlay() {
        ...
        val uri =  Uri.parse("android.resource://" + this?.getPackageName() + "/R.raw/" + R.raw.spalsh4);
...
//        tts_vids.setVideoPath("https://invoiz-assets.s3.amazonaws.com/hearts.mp4")
    ...
    override fun onResume() {
        super.onResume()
        handler.postDelayed(runnable, TimeUnit.SECONDS.toMillis(21))
    }
