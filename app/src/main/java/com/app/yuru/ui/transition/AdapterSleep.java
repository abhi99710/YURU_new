...
public class AdapterSleep extends RecyclerView.Adapter<AdapterSleep.MyHolder> {
    ...
    public AdapterSleep(Context context, List<String> ids, List<String> traint, List<String> thumb, List<String> duration,
                        List<String> url, ClickInterface clickInterface, LongPressSleep2 longPressSleep2, String trait) {
...
//            context.startActivity(intent);
        ...
        holder.sleep_videoview.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                longPressSleep2.longPressId(url.get(position), trait);
                return true;
            }
        });
    }
